...
public class TeamBedLocationUIPage extends InteractiveCustomUIPage<TeamBedLocationUIPage.BedData> {
    ...
    public static class BedData {
        ...
        public static final BuilderCodec<BedData> CODEC =
                BuilderCodec.builder(BedData.class, BedData::new)
                        .addField(
    ...
    public TeamBedLocationUIPage(PlayerRef playerRef, BedwarsMap map, BedwarsTeam team) {
        super(playerRef, CustomPageLifetime.CanDismissOrCloseThroughInteraction, BedData.CODEC);
        thisMap = map;
        thisTeam = team;
    }
    ...
    @Override
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull BedData data) {
        ...
        switch (data.button) {
            ...
            case "Submit" -> {
                try {
                    ...
                    thisTeam.setBedLocation(new Vector3d(x, y, z));
